...
public class PersianDateTest {
  ...
  @Test
  public void JalaliToGrgTest() throws JSONException {
  ...
  @Test
  public void grgToJalaliTest() throws JSONException {
    JSONObject obj = new JSONObject(testCase);
  ...
  @Test
  public void testIsTodayMethodWithoutParameter() {
    PersianDate pDate = new PersianDate();
    assertTrue(pDate.isToday());
    assertFalse(pDate.addDay().isToday());
  }
  @Test
  public void testIsTodayMethodWithParameter() {
    PersianDate pDate = new PersianDate();
  ...
  @Test
  public void testSetJalaliMonth() {
    PersianDate pDate = new PersianDate();
    pDate.setShMonth(1);
  ...
  public void testSetJalaliMonthExceptionBiggerThan12() {
    PersianDate pDate = new PersianDate();
    pDate.setShMonth(13);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testSetJalaliMonthExceptionSmallerThan1() {
    PersianDate pDate = new PersianDate();
    pDate.setShMonth(0);
  }

  @Test
  public void testSetJalaliYear() {
    PersianDate pDate = new PersianDate();
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testSetJalaliYearExceptionSmallerThan1() {
    PersianDate pDate = new PersianDate();
    pDate.setShYear(0);
  }

  @Test
  public void testSetJalaliDay() {
    PersianDate pDate = new PersianDate();
    pDate.setShDay(1);
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testSetJalaliDayExceptionBiggerThan31() {
    PersianDate pDate = new PersianDate();
    pDate.setShDay(32);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testSetJalaliDayExceptionSmallerThan1() {
    PersianDate pDate = new PersianDate();
    pDate.setShDay(0);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testSetJalaliDayExceptionWrongDayForMonth() {
    PersianDate pDate = new PersianDate();
    pDate.setShMonth(11);
    pDate.setShDay(31);
  }
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testSetGrgYearExceptionSmallerThan1() {
    PersianDate pDate = new PersianDate();
    pDate.setGrgYear(0);
  }

  @Test
  public void testSetGrgMonth() {
    PersianDate pDate = new PersianDate();
    pDate.setGrgMonth(1);
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testSetGrgMonthExceptionBiggerThan12() {
    PersianDate pDate = new PersianDate();
    pDate.setGrgMonth(13);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testSetGrgMonthExceptionSmallerThan1() {
    PersianDate pDate = new PersianDate();
    pDate.setGrgMonth(0);
  }

  @Test
  public void testSetGrgDay() {
    PersianDate pDate = new PersianDate();
    pDate.setGrgDay(1);
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testSetGrgDayExceptionBiggerThan31() {
    PersianDate pDate = new PersianDate();
    pDate.setGrgDay(32);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testSetGrgDayExceptionSmallerThan1() {
    PersianDate pDate = new PersianDate();
    pDate.setGrgDay(0);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testSetGrgDayExceptionWrongDayForMonth() {
    PersianDate pDate = new PersianDate();
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testSetSecondWithInvalidValue() {
    PersianDate pDate = new PersianDate();
    pDate.setSecond(60);
  }
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testSetMinuteWithInvalidValue() {
    PersianDate pDate = new PersianDate();
    pDate.setMinute(60);
  }
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testSetHourWithInvalidValue() {
    PersianDate pDate = new PersianDate();
    pDate.setHour(24);
  }

  @Test
  public void testGetGrgMonthLength() {
    PersianDate pDate = new PersianDate();
    pDate.setGrgMonth(1);
  ...
  @Test
  public void testGetGrgMonthLengthWithDateParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setGrgMonth(1);
    assertEquals(31, pDate.getGrgMonthLength(pDate.toDate()));
  }
  ...
  @Test
  public void testGetGrgMonthLengthWithYearAndMonthParameters() {
    PersianDate pDate = new PersianDate();
    assertEquals(31, pDate.getGrgMonthLength(2022,1));
  }

  @Test
  public void testInitGrgDate() {
    PersianDate pDate = new PersianDate();
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testInitGrgDateWithInvalidYear() {
    PersianDate pDate = new PersianDate();
    pDate.initGrgDate(0,13,1,23,59,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitGrgDateWithInvalidMonth() {
    PersianDate pDate = new PersianDate();
    pDate.initGrgDate(2022,13,1,23,59,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitGrgDateWithInvalidDay() {
    PersianDate pDate = new PersianDate();
    pDate.initGrgDate(2022,1,0,23,59,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitGrgDateWithInvalidDayForSpecificMonth() {
    PersianDate pDate = new PersianDate();
    pDate.initGrgDate(2022,11,31,23,59,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitGrgDateWithInvalidHour() {
    PersianDate pDate = new PersianDate();
    pDate.initGrgDate(2022,1,1,24,59,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitGrgDateWithInvalidMinute() {
    PersianDate pDate = new PersianDate();
    pDate.initGrgDate(2022,1,1,23,60,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitGrgDateWithInvalidSecond() {
    PersianDate pDate = new PersianDate();
  ...
  @Test
  public void testInitJalaliDate() {
    PersianDate pDate = new PersianDate();
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testInitJalaliDateWithInvalidYear() {
    PersianDate pDate = new PersianDate();
    pDate.initJalaliDate(0,13,1,23,59,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitJalaliDateWithInvalidMonth() {
    PersianDate pDate = new PersianDate();
    pDate.initJalaliDate(1399,13,1,23,59,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitJalaliDateWithInvalidDay() {
    PersianDate pDate = new PersianDate();
    pDate.initJalaliDate(1399,1,0,23,59,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitJalaliDateWithInvalidDayForSpecificMonth() {
    PersianDate pDate = new PersianDate();
    pDate.initJalaliDate(1399,11,31,23,59,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitJalaliDateWithInvalidHour() {
    PersianDate pDate = new PersianDate();
    pDate.initJalaliDate(1399,1,1,24,59,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitJalaliDateWithInvalidMinute() {
    PersianDate pDate = new PersianDate();
    pDate.initJalaliDate(1399,1,1,23,60,13);
  }
  @Test(expected = IllegalArgumentException.class)
  public void testInitJalaliDateWithInvalidSecond() {
    PersianDate pDate = new PersianDate();
  ...
  @Test
  public void testAddDayWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setShDay(1);
    pDate.addDays(2);
  ...
  @Test
  public void testAddMonthWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setShMonth(1);
    pDate.addMonths(2);
  ...
  @Test
  public void testAddYearWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setShYear(1399);
    pDate.addYears(2);
  ...
  @Test
  public void testAddHourWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setHour(1);
    pDate.addHours(2);
  ...
  @Test
  public void testAddMinuteWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setMinute(1);
    pDate.addMinutes(2);
  ...
  @Test
  public void testAddSecondWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setSecond(1);
    pDate.addSeconds(2);
  ...
  @Test
  public void testAddWeekWithParameter() {
    PersianDate pDate = new PersianDate().initJalaliDate(1399,1,1);
    pDate.addWeeks(3);
  ...
  @Test
  public void testSubDayWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setShDay(3);
    pDate.subDays(2);
    assertEquals(1, pDate.getShDay());
  ...
  @Test
  public void testSubMonthWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setShMonth(3);
    pDate.subMonths(2);
    assertEquals(1, pDate.getShMonth());
  ...
  @Test
  public void testSubYearWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setShYear(1399);
    pDate.subYears(2);
  ...
  @Test
  public void testSubHourWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setHour(3);
    pDate.subHours(2);
  ...
  @Test
  public void testSubMinuteWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setMinute(3);
    pDate.subMinutes(2);
  ...
  @Test
  public void testSubSecondWithParameter() {
    PersianDate pDate = new PersianDate();
    pDate.setSecond(3);
    pDate.subSeconds(2);
  ...
  @Test
  public void testSubWeekWithParameter() {
